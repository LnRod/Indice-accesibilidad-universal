...
# =======================================
# 8) Puntaje 0/1 según tiempo umbral — actualizado a 23 min
# =======================================
origenes <- origenes %>%
  mutate(
    acceso_PcD = if_else(time_PcD_min <= 23, 1L, 0L),
    acceso_PsD = if_else(time_PsD_min <= 23, 1L, 0L)
  )
...
# Guardar
st_write(manzanas_final, "puntaje_distancia_equip_salud.geojson", delete_layer = TRUE)
