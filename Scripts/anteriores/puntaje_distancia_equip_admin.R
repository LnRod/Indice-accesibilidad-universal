...
destinos <- st_read("C:/Users/pcusu/Desktop/Accesibilidad_CABA/Datos/Datos_indice/equip_asis.geojson")
...
# =======================================
# 8) Puntaje 0/1 según tiempo umbral — actualizado a 26 min
# =======================================
origenes <- origenes %>%
  mutate(
    acceso_PcD = if_else(time_PcD_min <= 26, 1L, 0L),
    acceso_PsD = if_else(time_PsD_min <= 26, 1L, 0L)
  )
...
# Guardar
st_write(manzanas_final, "puntaje_distancia_equip_admin.geojson", delete_layer = TRUE)
