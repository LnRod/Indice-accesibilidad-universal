...
# ==========================================
# 2) Calcular puntaje correcto de destinos (administrativos)
# ==========================================
...
manzanas <- st_read("puntaje_distancia_equip_admin.geojson")
...
#    Para 26 min → PcD = ~1083 m | PsD = ~2167 m
# ==========================================
vecinos_PcD <- st_nn(manzanas_PcD, destinos_puntaje, k = 5, maxdist = 1083)
vecinos_PsD <- st_nn(manzanas_PsD, destinos_puntaje, k = 5, maxdist = 2167)
...
# ==========================================
st_write(manzanas_final, "puntaje_facilidades_admin.geojson", delete_dsn = TRUE)
